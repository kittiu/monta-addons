...
class account_config_settings(osv.osv_memory):
    ...
    _columns = {
        'property_account_wholesale_disc_customer': fields.many2one('account.account', 'Account Wholesale Discount Customer'),
        'property_account_wholesale_disc_supplier': fields.many2one('account.account', 'Account Wholesale Discount Supplier'),
    ...
    def set_default_account_advance(self, cr, uid, ids, context=None):
        ...
        todo_list = [
            ('property_account_wholesale_disc_customer', 'res.partner', 'account.account'),
            ('property_account_wholesale_disc_supplier', 'res.partner', 'account.account'),
    ...
    def get_default_account_advance(self, cr, uid, fields, context=None):
        ...
        todo_list = [
            ('property_account_wholesale_disc_customer', 'res.partner'),
            ('property_account_wholesale_disc_supplier', 'res.partner'),
